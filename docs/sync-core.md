...
- `observability/report-content.ts` defines report fields, legacy labels, and operation sections for both Markdown and Notion blocks. Existing Sync Log properties and report content remain; no new database properties are required.
